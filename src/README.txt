Зарание извиняюс, в коде могут быть ошибки, пришлось писать без возможности т.к. спарк не давал ничего сделать и после запуска каждого скрипта закрывался
